...
public class ProxyClass extends SubjectImplementaton {
    ...
    public void myMethod() {
        System.out.println("This is proxy class and this method for checking authentication and security checks");
        ...
        System.out.println("Calling real method of SubjectImplementation class after the call is authenticated");
        super.myMethod();
    }
